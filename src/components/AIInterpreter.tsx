              ...
              <div className="p-4 bg-sky-50 dark:bg-sky-950/20 border border-sky-200 dark:border-sky-900/50 rounded-xl text-xs text-sky-850 dark:text-sky-300 flex items-start gap-2.5 animate-pulse shadow-sm">
                ...
                <div className="space-y-1 text-left">
                  ...
                  <p className="leading-relaxed font-semibold">
                    Máy chủ Gemini 3.5 Flash của Google hiện tại đang nhận lưu lượng quá tải cục bộ (Báo lỗi bận 503). 
                    Để bản luận giải không bị ngắt quãng hoặc chết đứng, hệ thống đã <span className="text-amber-600 dark:text-amber-400 font-extrabold">tự động định tuyến cuộc gọi thành công qua Gemini 3.1 Lite dự phòng</span> hoàn toàn êm ái cho quý vị!
                  </p>
                </div>
              </div>
            )}
